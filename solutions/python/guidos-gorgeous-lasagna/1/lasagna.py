...
PREPARATION_TIME = 2
"""Functions to prevent lasagna-cooking disasters."""
...
def preparation_time_in_minutes(number_of_layers: int):
    ...
    how many minutes you would spend preparing them based on the PREPARATION_TIME.
    """
...
def elapsed_time_in_minutes(number_of_layers: int, elapsed_bake_time: int):
    ...
    :return: int - total elapsed time (preparation + baking) in minutes.

    This function returns the total sum of preparation time and cooking time.
    """
